  ...
  return (
    <Card className="w-full border-slate-100 shadow-xl shadow-slate-200/50 rounded-3xl p-2 pb-6">
      ...
      <CardContent className="space-y-6 pt-4">
        {/* Tabs */}
        <Tabs defaultValue="signin" className="w-full" onValueChange={(val) => val === 'signup' && navigate('/sign-up')}>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div className="text-center pt-2">
            <p className="text-sm font-medium text-slate-500">
              New to CareNest?{" "}
              <Link to="/sign-up" className="text-blue-600 hover:text-blue-700 font-bold hover:underline">
                Create account
              </Link>
            </p>
          </div>
